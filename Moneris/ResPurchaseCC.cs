...
{
	[ComVisible(true)]
	public class ResPurchaseCC : Transaction
	{
		...
		public ResPurchaseCC()
			: base(xmlTags)
		{
		}

		public ResPurchaseCC(Hashtable respurchasecc)
			: base(respurchasecc, xmlTags)
		{
		}

		public ResPurchaseCC(string data_key, string order_id, string amount, string crypt_type)
			: base(xmlTags)
		{
		...
		public ResPurchaseCC(string data_key, string order_id, string cust_id, string amount, string crypt_type)
			: base(xmlTags)
		{
			transactionParams.Add("data_key", data_key);
			transactionParams.Add("order_id", order_id);
		...
		{
			string str = ((!country.Equals("US")) ? "res_purchase_cc" : "us_res_purchase_cc");
