...
{
	[ComVisible(true)]
	public class EncTrack2Forcepost : Transaction
	{
		...
		public EncTrack2Forcepost()
			: base(xmlTags)
		{
		}

		public EncTrack2Forcepost(string order_id, string amount, string enc_track2, string pos_code, string device_type, string auth_code)
			: base(xmlTags)
		{
		...
		public EncTrack2Forcepost(string order_id, string cust_id, string amount, string enc_track2, string pos_code, string device_type, string auth_code)
			: base(xmlTags)
		{
			transactionParams.Add("order_id", order_id);
		...
		{
			string str = ((!country.Equals("US")) ? "enc_track2_forcepost" : "us_enc_track2_forcepost");
