...
{
	[ComVisible(true)]
	public class ResCavvPurchaseCC : Transaction
	{
		...
		public ResCavvPurchaseCC()
			: base(xmlTags)
		{
		}

		public ResCavvPurchaseCC(Hashtable res_cavv_purchase_cc)
			: base(res_cavv_purchase_cc, xmlTags)
		{
		}

		public ResCavvPurchaseCC(string data_key, string order_id, string amount, string cavv)
			: base(xmlTags)
		{
		...
		public ResCavvPurchaseCC(string data_key, string order_id, string cust_id, string amount, string cavv)
			: base(xmlTags)
		{
			transactionParams.Add("data_key", data_key);
			transactionParams.Add("order_id", order_id);
		...
		{
			string str = ((!country.Equals("US")) ? "res_cavv_purchase_cc" : "us_res_cavv_purchase_cc");
