...
{
	[ComVisible(true)]
	public class EncTrack2Purchase : Transaction
	{
		...
		public EncTrack2Purchase()
			: base(xmlTags)
		{
		}

		public EncTrack2Purchase(Hashtable enctrack2purchase)
			: base(enctrack2purchase, xmlTags)
		{
		}

		public EncTrack2Purchase(string order_id, string amount, string enc_track2, string pos_code, string device_type)
			: base(xmlTags)
		{
		...
		public EncTrack2Purchase(string order_id, string cust_id, string amount, string enc_track2, string pos_code, string device_type)
			: base(xmlTags)
		{
			transactionParams.Add("order_id", order_id);
		...
		{
			string str = ((!country.Equals("US")) ? "enc_track2_purchase" : "us_enc_track2_purchase");
