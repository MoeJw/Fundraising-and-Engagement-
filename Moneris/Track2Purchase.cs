...
{
	[ComVisible(true)]
	public class Track2Purchase : Transaction
	{
		...
		public Track2Purchase(Hashtable track2purchase)
			: base(track2purchase, xmlTags)
		{
		}

		public Track2Purchase(string order_id, string amount, string track2, string pan, string expdate, string pos_code)
			: base(xmlTags)
		{
		...
		public Track2Purchase(string order_id, string cust_id, string amount, string track2, string pan, string expdate, string pos_code)
			: base(xmlTags)
		{
			transactionParams.Add("order_id", order_id);
		...
		public Track2Purchase(string order_id, string cust_id, string amount, string track2, string pan, string expdate, string pos_code, string commcard_invoice, string commcard_tax_amount)
			: base(xmlTags)
		{
			transactionParams.Add("order_id", order_id);
			transactionParams.Add("cust_id", cust_id);
		...
		{
			string str = ((!country.Equals("US")) ? "track2_purchase" : "us_track2_purchase");
