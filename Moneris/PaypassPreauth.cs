...
{
	[ComVisible(true)]
	public class PaypassPreauth : Transaction
	{
		...
		public PaypassPreauth()
			: base(xmlTags)
		{
		}

		public PaypassPreauth(Hashtable paypass_preauth)
			: base(paypass_preauth, xmlTags)
		{
		}

		public PaypassPreauth(string order_id, string amount, string mp_request_token, string crypt_type)
			: base(xmlTags)
		{
		...
		public PaypassPreauth(string order_id, string cust_id, string amount, string mp_request_token, string crypt_type)
			: base(xmlTags)
		{
			transactionParams.Add("order_id", order_id);
		...
		{
			string str = ((!country.Equals("US")) ? "paypass_preauth" : "us_paypass_preauth");
