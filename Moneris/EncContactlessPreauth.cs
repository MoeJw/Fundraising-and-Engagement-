...
{
	[ComVisible(true)]
	public class EncContactlessPreauth : Transaction
	{
		...
		public EncContactlessPreauth()
			: base(xmlTags)
		{
		}

		public EncContactlessPreauth(Hashtable encContactlessPreauth)
			: base(encContactlessPreauth, xmlTags)
		{
		}

		public EncContactlessPreauth(string order_id, string amount, string enc_track2, string pos_code, string device_type)
			: base(xmlTags)
		{
		...
		public EncContactlessPreauth(string order_id, string cust_id, string amount, string enc_track2, string pos_code, string device_type)
			: base(xmlTags)
		{
			transactionParams.Add("order_id", order_id);
		...
		{
			string str = ((!country.Equals("US")) ? "enc_contactless_preauth" : "us_enc_contactless_preauth");
