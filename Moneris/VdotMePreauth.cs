...
{
	[ComVisible(true)]
	public class VdotMePreauth : Transaction
	{
		...
		public VdotMePreauth()
			: base(xmlTags)
		{
		}

		public VdotMePreauth(Hashtable preauth)
			: base(preauth, xmlTags)
		{
		}

		public VdotMePreauth(string order_id, string amount, string call_id, string crypt_type)
			: base(xmlTags)
		{
		...
		public VdotMePreauth(string order_id, string cust_id, string amount, string call_id, string crypt_type)
			: base(xmlTags)
		{
			transactionParams.Add("order_id", order_id);
		...
		{
			string str = ((!country.Equals("US")) ? "vdotme_preauth" : "us_vdotme_preauth");
